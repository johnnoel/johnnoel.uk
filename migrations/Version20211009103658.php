 ...
 */
final class Version20211009103658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , name VARCHAR(255) NOT NULL COLLATE BINARY, alias VARCHAR(255) NOT NULL COLLATE BINARY, url CLOB DEFAULT NULL COLLATE BINARY, rss_url CLOB DEFAULT NULL COLLATE BINARY, code_url CLOB DEFAULT NULL COLLATE BINARY, description CLOB DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_2FB3D0EE6BF700BD FOREIGN KEY (status_id) REFERENCES project_status (id) ON DELETE RESTRICT NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        , name VARCHAR(255) NOT NULL, alias VARCHAR(255) NOT NULL, url CLOB DEFAULT NULL, rss_url CLOB DEFAULT NULL, code_url CLOB DEFAULT NULL, description CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO project (id, status_id, name, alias, url, description, rss_url, code_url) SELECT id, status_id, name, alias, url, description, rss_url, code_url FROM __temp__project');
        $this->addSql('DROP TABLE __temp__project');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2FB3D0EEE16C6B94 ON project (alias)');
        $this->addSql('CREATE INDEX IDX_2FB3D0EE6BF700BD ON project (status_id)');
